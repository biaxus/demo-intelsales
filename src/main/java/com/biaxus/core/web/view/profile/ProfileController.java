...
public class ProfileController {
	...
	public String profile(Profile profile, Model model, Principal principal) {
		initModel(profile, model, principal);
		return "user/profile-update";
	}
	
	private void initModel(Profile profile, Model model, Principal principal){
		if (principal != null) {
	...
	public String addEnterprise(Profile profile, Model model, Principal principal) {
		initModel(profile, model, principal);
