(function($) {
	var $messageContainer = $(messageContainer), $formContainer = $(formContainer), $listContainer = $(listContainer), controller = {
		...
		save : function() {
			...
			$.post('/fn/client', data, success).fail(fail).always(always);
		},
		_new : function() {
			var data = {
				id : $id.val(),
			...
			$.post('/fn/client/edit', data, success).fail(fail).always(always);
		},
		...
		reloadList : function() {
			...
			$.get('/fn/client/list', success).fail(fail).always(always);
		},
